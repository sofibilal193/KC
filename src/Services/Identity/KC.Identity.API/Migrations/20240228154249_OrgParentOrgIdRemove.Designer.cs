...
namespace KC.Identity.API.Migrations
{
    ...
    [Migration("20240228154249_OrgParentOrgIdRemove")]
    partial class OrgParentOrgIdRemove
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("KC.Identity.API.Entities.Org", b =>
                {
                    ...
                    b.OwnsMany("KC.Identity.API.Entities.OrgGroup", "Groups", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")

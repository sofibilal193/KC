...
namespace KC.Config.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // services.AddConfigApi(Configuration, Environment);

            // var sqlSettings = Configuration.GetSqlServerSettings(Global.ApplicationName);
            // services.AddSqlEventsPersistence(sqlSettings, Configuration.GetConnectionString("ConfigDbConnection"));
            // services.AddSqlIntegrationEventLogService(
        ...
        {
            var enableHttpLogging = config.GetSection(Global.ApplicationName).GetValue<bool>("EnableHttpLogging");
